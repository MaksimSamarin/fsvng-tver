...
for pid, nm in [("p-memo","Памятка"),("p-vu","Устав ВС"),("p-du","Дисциплинарный"),
                ("p-uk","Караульный"),("p-le","Лекции"),("p-ru","Повышение"),("p-av","Карта обязанностей АВНГ"),("p-as","Система повышения АВНГ"),("p-ex","Экзамен"),
...
panes=["p-memo","p-ru","p-le","p-av","p-as","p-vu","p-du","p-uk","p-ug","p-ap","p-pk","p-fo","p-fw","p-fs","p-fe","p-fm","p-ex"]
...
for name,expect in [("Форма на присягу","p-le"),('id="dress"',"p-le"),('id="posts-vch"',"p-le"),("Как подать отчёт","p-ru"),('id="av-order"',"p-av"),('id="as-points"',"p-as")]:
