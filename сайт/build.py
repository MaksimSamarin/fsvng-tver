...
ROUTE = ('<div class="route">'
 ...
 '<div class="rstep"><span class="rr">Ранг 2</span><span class="rt">Ефрейтор</span><span class="rd">После лекции, экскурсии, спец. связи, физподготовки и присяги</span></div>'
 '<div class="rstep"><span class="rr">Ранг 3</span><span class="rt">Мл. сержант</span><span class="rd">После стрельбища, полосы, караула, экзамена и строевой</span></div>'
 '<div class="rstep"><span class="rr">После 3</span><span class="rt">РВО</span><span class="rd">Зачисление автоматически. Дальше — заявка в ОМОН, ОСБ, КС или АВНГ, по одобрению</span></div>'
...
STAGE23 = ('<div class="stage"><div class="stage-h"><h3 class="chapter sg" id="ru-st23" data-short="Ранг 2 → 3">Ранг 2 → 3</h3>'
 ...
 + task(2, "Пройти тренировочную площадку",
        "<p>Полоса препятствий.</p>"
        + links(xl("Требования к скриншотам", "p-memo", "s12")), "2 скриншота: начало и конец")
 + task(3, "Отстоять караул 1 час",
 ...
 + task(4, "Сдать экзамен по внутренним НПА",
 ...
 + task(5, "Пройти строевую подготовку",
        "<p>Отдельное занятие с инструктором: строевая стойка, выход из строя, доклад. Не путать с лекцией по строевой на этапе 1 → 2 — это практика.</p>"
...
SUBMIT = ('<h3 class="chapter" id="ru-submit" data-short="Подача отчёта">Как подать отчёт и запрос</h3>'
 ...
 '<p>Отчёт проверяет Академия ВНГ — последней строкой её тег. Для этапа 2 → 3 в третьем пункте перечисляются задачи этого этапа: стрельбище, тренировочная площадка, караул, экзамен, строевая подготовка.</p>'
...
AFTER = ('<h3 class="chapter" id="ru-after" data-short="Что дальше">Что дальше</h3>'
 ...
 'Находясь в РВО, можно подать заявку на перевод в другое подразделение — только по одобрению принимающего. '
 ...
 '<tr><td><strong>РВО</strong></td><td>Рота вневедомственной охраны — сюда зачисляют после 3 ранга</td></tr>'
 ...
 '<tr><td><strong>АВНГ</strong></td><td>Академия ВНГ — обучение курсантов. КС и АВНГ — два разных подразделения</td></tr>'
 '</tbody></table></div>'
...
AV_DOCS = ('<div class="avsub"><p class="h">Шесть документов лекции и экзамена</p><ol>'
           '<li>Лекция «Постовая служба»</li><li>Лекция по субординации</li><li>Лекция «Строевая подготовка»</li>'
           '<li>Дресс-код ФСВНГ</li><li>Дисциплинарный устав</li><li>Устав ВС РФ и ФСВНГ</li></ol></div>')
...
AV_LADDER = (
    ...
    av_level(2, "II", "Ступень II · Инструктор АВНГ", "II · Инструктор", [
        ...
        av_li("Лекция по внутренним НПА", "разово, сразу по всем шести документам", "этап 1 → 2"),
    ...
    av_level(1, "I", "Ступень I · Рядовой сотрудник АВНГ", "I · Рядовой сотрудник", [
        ...
        av_li("Занятие по физподготовке", "", "этап 1 → 2"),
        av_li("Стрельбище", "", "этап 2 → 3"),
        av_li("Полоса препятствий", "", "этап 2 → 3"),
        av_li("Строевая подготовка", "отдельное занятие, не лекция", "этап 2 → 3"),
...
AV_SOURCES = ('<h3 class="chapter" id="av-src" data-short="Основания">Основания</h3><div class="tw"><table>'
 ...
 '<tr><td><b>Система повышения</b></td><td>Пост Нач.АВНГ от 20.09.2026: шесть задач этапа 1 → 2, пять задач этапа 2 → 3, сопровождение выездов сотрудниками АВНГ, отчёты на АВНГ</td></tr>'
 '</table></div>')
