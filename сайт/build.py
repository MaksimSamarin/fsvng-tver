...
ROUTE = ('<div class="route">'
 ...
 '<div class="rstep"><span class="rr">Ранг 3</span><span class="rt">Мл. сержант</span><span class="rd">После стрельбища, полосы, караула и экзамена</span></div>'
...
STAGE12 = ('<div class="stage"><div class="stage-h"><h3 class="chapter sg" id="ru-st12" data-short="Ранг 1 → 2">Ранг 1 → 2</h3>'
 '<span class="cnt">6 задач</span><span class="note-inline">Выезд за территорию ВЧ — только с Кадровой службой</span></div>'
 '<div class="tasks">'
...
STAGE23 = ('<div class="stage"><div class="stage-h"><h3 class="chapter sg" id="ru-st23" data-short="Ранг 2 → 3">Ранг 2 → 3</h3>'
 '<span class="cnt">4 задачи</span><span class="note-inline">После 3 ранга — автоматически в РВО</span></div>'
 '<div class="tasks">'
...
SUBMIT = ('<h3 class="chapter" id="ru-submit" data-short="Подача отчёта">Как подать отчёт и запрос</h3>'
 ...
 '<p>Отчёт проверяет Академия ВНГ — последней строкой её тег. Для этапа 2 → 3 в третьем пункте перечисляются задачи этого этапа: стрельбище, тренировочная площадка, караул, экзамен.</p>'
...
ru = dochead("du_", "Путь курсанта", "Система повышения",
             "Открыл — и сразу видно, что делать. Десять задач до 3 ранга, потом РВО и рост внутри своей структуры. "
             "Под каждой задачей написано, что именно приложить в отчёт.",
             ["<b>6 задач</b> на ранг 1 → 2", "<b>4 задачи</b> на ранг 2 → 3", "Военный билет с <b>6 ранга</b>"]) + \
