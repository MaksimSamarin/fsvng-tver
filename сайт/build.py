...
CHANS_CARDS = '''<div class="chans">
  ...
  <a class="chan ch3" href="discord://-/channels/1538938584441163776/1550924926582653139">
...
DRESS = ('<h3 class="chapter" id="dress" data-short="Дресс-код ФСВНГ">Дресс-код ФСВНГ</h3>'
    '<p>Один из семи документов лекции по внутренним НПА. По <strong>ст. 3.1 Устава ВС</strong> форма обязана соответствовать '
...
le = dochead("dl", "Внутренние материалы", "Лекции ФСВНГ",
             ...
             "субординация, дресс-код, строевая подготовка, Дисциплинарный устав, Устав ВС и Устав караульно-постовой службы. "
             "Экзамен тоже <strong>один, по всему материалу целиком</strong>, а не по каждому блоку отдельно.",
             ["Одна лекция — <b>7 документов</b>", "Присяга и посты", "Экзамен на ранге <b>2 → 3</b>"]) + \
...
ROUTE = ('<div class="route">'
 '<div class="rstep now"><span class="rr">Ранг 1</span><span class="rt">Кадет</span><span class="rd">Стартовый ранг. Выезд из части — только с Академией ВНГ</span></div>'
 '<div class="rstep"><span class="rr">Ранг 2</span><span class="rt">Ефрейтор</span><span class="rd">После удостоверения, экскурсии, строевой, лекции по НПА, присяги и спец. связи</span></div>'
 '<div class="rstep"><span class="rr">Ранг 3</span><span class="rt">Мл. сержант</span><span class="rd">После стрельбища, физподготовки, полосы, караула и экзамена</span></div>'
 '<div class="rstep"><span class="rr">После 3</span><span class="rt">РВО</span><span class="rd">Переход автоматически. С 5 ранга — перевод в ОМОН, ОСБ или КС, по одобрению</span></div>'
...
STAGE12 = ('<div class="stage"><div class="stage-h"><h3 class="chapter sg" id="ru-st12" data-short="Ранг 1 → 2">Ранг 1 → 2</h3>'
 '<span class="cnt">6 задач</span><span class="note-inline">Выезд за территорию ВЧ — только с Академией ВНГ</span></div>'
 '<div class="tasks">'
 + task(1, "Получить удостоверение",
        "<p>Оформляется в здании правительства. Выезд туда — в сопровождении сотрудника Академии ВНГ, самостоятельно ехать нельзя.</p>")
 + task(2, "Прослушать лекцию-экскурсию по ВЧ",
        ...
        + links(xl("Посты воинской части", "p-le", "posts-vch"), xl("Посты на Алабино", "p-le", "posts"),
                xl("Требования к скриншотам", "p-memo", "s12")), "2 скриншота: начало и конец экскурсии")
 + task(3, "Пройти строевую подготовку",
        "<p>Отдельное занятие с инструктором: строевая стойка, выход из строя, доклад. Не путать с лекцией по строевой — это практика.</p>"
        + links(xl("Строевая подготовка", "p-le", "le3-h1"), xl("Требования к скриншотам", "p-memo", "s12")),
        "2 скриншота: начало и конец")
 + task(4, "Прослушать лекцию по внутренним НПА",
        "<p>Инструктор проводит её <strong>разово и сразу по всем семи документам:</strong></p>"
        "<ol><li>Лекция «Постовая служба»</li><li>Лекция по субординации</li><li>Дресс-код ФСВНГ</li>"
        "<li>Лекция «Строевая подготовка»</li><li>Дисциплинарный устав</li><li>Устав ВС РО и ФСВНГ</li>"
        "<li>Устав караульно-постовой службы</li></ol>"
        "<p>Экзамен здесь не сдаётся — он будет на этапе 2 → 3.</p>"
        + links(xl("Постовая служба", "p-le", "le1-h7"), xl("Субординация", "p-le", "le2-h3"),
                xl("Дресс-код", "p-le", "dress"), xl("Строевая подготовка", "p-le", "le3-h1"),
                xl("Дисциплинарный устав", "p-du", "du-a6"), xl("Устав ВС", "p-vu", "vu-a1-1"),
                xl("Караульно-постовой устав", "p-uk", "uk-a36")))
 + task(5, "Принять присягу",
 ...
 + task(6, "Подключиться к государственной спец. связи",
...
STAGE23 = ('<div class="stage"><div class="stage-h"><h3 class="chapter sg" id="ru-st23" data-short="Ранг 2 → 3">Ранг 2 → 3</h3>'
 '<span class="cnt">5 задач</span><span class="note-inline">Выезд с территории ВЧ — только с Академией ВНГ</span></div>'
 '<div class="tasks">'
 + task(1, "Отстрелять на стрельбище",
        "<p>Практическое занятие с инструктором. Выезд с территории ВЧ — только с сотрудниками Академии ВНГ, самостоятельный выезд запрещён.</p>"
        + links(xl("Требования к скриншотам", "p-memo", "s12")), "2 скриншота: начало и завершение")
 + task(2, "Пройти занятие по физподготовке",
        "<p>Проводит инструктор.</p>"
        + links(xl("Требования к скриншотам", "p-memo", "s12")), "2 скриншота: начало и конец")
 + task(3, "Пройти полосу препятствий",
        "<p>Тренировочная площадка.</p>"
        + links(xl("Требования к скриншотам", "p-memo", "s12")), "2 скриншота: начало и конец")
 ...
 + task(5, "Сдать экзамен по внутренним НПА",
        "<p><strong>Один экзамен сразу по всем семи документам</strong>, а не по каждому блоку отдельно.</p>"
        + links(xl("Памятка — что учить", "p-memo", "s1"), xl("30 вопросов к экзамену", "p-ex", "p-ex")),
...
FORM_REPORT = """1. Тегаете себя через @
2. С какого на какой ранг повышаетесь
3. Доказательства
4. Тегаете @[🎓] Академия Войск Национальной Гвардии"""

REPORT_EXAMPLE = """1. @Нач.АВНГ | А.Власов | 89014
2. 1-2
3.
1) Удостоверение - [ссылка]
2) Лекция-экскурсия по ВЧ - [ссылка]
3) Строевая подготовка - [ссылка]
4) Лекция по внутренним НПА - [ссылка]
5) Принятие присяги - [ссылка]
6) Получение роли на сервере гос.структур - [ссылка]
...
SUBMIT = ('<h3 class="chapter" id="ru-submit" data-short="Подача отчёта">Как подать отчёт и запрос</h3>'
 '<p>Два шага, порядок строгий: сначала отчёт сообщением в канал отчётов, дождаться отметки ✅ — и только потом запрос на повышение в канале запроса.</p>'
 '<div class="steps2">'
 '<div class="st2"><span class="s2n">Шаг 1</span><div class="s2t">Отчёт на повышение</div>'
 '<div class="s2d">Пишется сообщением в канал по форме ниже: в третьем пункте — по одной строке со ссылкой на доказательство на каждую задачу этапа. Ждём проверки и отметки ✅.</div>'
 '<a class="s2b" href="' + app_link(CH_REPORT) + '">Открыть канал отчётов →</a>'
 '<a class="webalt" href="' + CH_REPORT + '" target="_blank" rel="noopener">в браузере</a></div>'
 ...
 '</div>'
 '<h4>Форма отчёта</h4>'
 '<div class="cmd"><pre id="ru-rform">' + esc(FORM_REPORT) + '</pre>'
 '<button class="cp" data-c="ru-rform">Копировать</button></div>'
 '<h4>Пример отчёта на ранг 1 → 2</h4>'
 '<div class="cmd"><pre id="ru-rex">' + esc(REPORT_EXAMPLE) + '</pre>'
 '<button class="cp" data-c="ru-rex">Копировать</button></div>'
 '<p>Отчёт проверяет Академия ВНГ — последней строкой её тег. Для этапа 2 → 3 в третьем пункте перечисляются задачи этого этапа: стрельбище, физподготовка, полоса препятствий, караул, экзамен.</p>'
 ...
 '<p style="margin:0">В обоих сообщениях четыре пункта, порядок не менять, первым — свой тег через @. В отчёте последней строкой — тег Академии ВНГ, '
 'в запросе — тег Кадровой службы <code>@[👮] Кадровая служба ФСВНГ</code>. Ссылка в запросе — на уже одобренный отчёт. Сообщение не по форме не рассматривается.</p></div>')

AFTER = ('<h3 class="chapter" id="ru-after" data-short="Что дальше">Что дальше</h3>'
 '<p><strong>После 3 ранга</strong> ты автоматически переходишь в <strong>РВО</strong> — Роту вневедомственной охраны, выбирать ничего не нужно. '
 '<strong>С 5 ранга</strong> можно перевестись в ОМОН, ОСБ или Кадровую службу либо остаться в РВО — только по одобрению принимающего подразделения. '
 'Дальше растёшь по системе повышения своей структуры.</p>'
 '<div class="tw"><table><thead><tr><th>Подразделение</th><th>Чем занимается</th></tr></thead><tbody>'
 '<tr><td><strong>РВО</strong></td><td>Рота вневедомственной охраны — сюда переходят после 3 ранга</td></tr>'
 '<tr><td><strong>ОМОН</strong></td><td>Отряд мобильный особого назначения</td></tr>'
 '<tr><td><strong>ОСБ</strong></td><td>Отдел собственной безопасности — нарушения внутри ФСВНГ</td></tr>'
 '<tr><td><strong>КС</strong></td><td>Кадровая служба — кадровая работа по всему ФСВНГ</td></tr>'
 '<tr><td><strong>АВНГ</strong></td><td>Академия ВНГ — обучение курсантов. КС и АВНГ — два разных подразделения; в перечне переводов с 5 ранга академия не указана</td></tr>'
 '</tbody></table></div>'
...
PROOFS = ('<h3 class="chapter" id="ru-proofs" data-short="Доказательства">Доказательства</h3>'
 ...
 'сокращённое имя вроде «Лёха» вместо «Алексей» · скриншот фракционного Discord вместо Discord гос. фракций (State), где выдана роль Тверской · нарушена форма отчёта.</div>')

ru = dochead("du_", "Путь курсанта", "Система повышения",
             "Открыл — и сразу видно, что делать. Одиннадцать задач до 3 ранга, потом РВО и рост внутри своей структуры. "
             "Под каждой задачей написано, что именно приложить в отчёт.",
             ["<b>6 задач</b> на ранг 1 → 2", "<b>5 задач</b> на ранг 2 → 3", "Военный билет с <b>6 ранга</b>"]) + \
...
exam = ('<div class="dochead dd"><div class="abbr">Проверка знаний</div><h2>Вопросы к экзамену</h2>'
        '<p class="sub">Тридцать вопросов: двадцать по уставам и порядку службы, десять — назвать статью по описанной ситуации. Сначала ответь вслух, потом раскрывай ответ.</p>'
        '<div class="facts"><span>Раскрыто <b id="opened">0</b> из 30</span></div></div>' + exam_raw)
...
# ---------- сотруднику АВНГ: карта обязанностей ----------
def av_li(t, sub="", src=""):
    return '<li><span class="t">%s%s</span><span class="src">%s</span></li>' % (
        esc(t), ('<small>%s</small>' % esc(sub)) if sub else "", esc(src))

def av_level(n, num, title, short, items, extra=""):
    return ('<section class="avlev"><h3 class="chapter" id="av-l%d" data-short="%s">%s</h3>'
            '<div class="avrow"><div class="avp"><span class="avn">%s</span><small>ступень</small></div>'
            '<div><ul class="avd">%s</ul>%s</div></div></section>'
            % (n, esc(short), esc(title), num, "".join(items), extra))

AV_DOCS = ('<div class="avsub"><p class="h">Семь документов лекции и экзамена</p><ol>'
           '<li>Лекция «Постовая служба»</li><li>Лекция по субординации</li><li>Дресс-код ФСВНГ</li>'
           '<li>Лекция «Строевая подготовка»</li><li>Дисциплинарный устав</li><li>Устав ВС РО и ФСВНГ</li>'
           '<li>Устав караульно-постовой службы</li></ol></div>')

AV_LADDER = (
    av_level(4, "IV", "Ступень IV · Начальник АВНГ и заместитель", "IV · Начальник", [
        av_li("Доклады при построении", "", "ВУ ст. 1.7"),
        av_li("Проведение набора по утверждённому графику", "агитационные мероприятия и призывы", "ВУ ст. 1.8"),
        av_li("Проверка личного состава"),
        av_li("Допуск и аттестация инструкторов"),
    ]) +
    av_level(3, "III", "Ступень III · Старший инструктор АВНГ", "III · Старший инструктор", [
        av_li("Обучение инструкторов"),
        av_li("Контроль за рядовыми сотрудниками и инструкторами АВНГ"),
        av_li("Проверка отчётов сотрудников АВНГ на повышение, отметка ✅"),
        av_li("Повторный инструктаж и переаттестация после нарушений",
              "до повторного допуска после нарушения правил оружия, КПП, связи или постовой службы", "ВУ ст. 8.3 · ДУ ст. 6"),
        av_li("Представление курсантов и сотрудников к повышению", "по согласованию с вышестоящим командованием", "ВУ ст. 8.2"),
    ]) +
    av_level(2, "II", "Ступень II · Инструктор АВНГ", "II · Инструктор", [
        av_li("Проведение присяги", "ежедневно 12:00 и 20:00 на плацу, в порядке исключения — в другое время", "ВУ ст. 1.11"),
        av_li("Лекция по внутренним НПА", "разово, сразу по всем семи документам", "этап 1 → 2"),
        av_li("Экзамен по внутренним НПА", "один, по всему материалу", "этап 2 → 3"),
        av_li("Помощь рядовым сотрудникам АВНГ"),
    ], AV_DOCS) +
    av_level(1, "I", "Ступень I · Рядовой сотрудник АВНГ", "I · Рядовой сотрудник", [
        av_li("Лекция-экскурсия по ВЧ", "", "этап 1 → 2"),
        av_li("Строевая подготовка", "отдельное занятие, не лекция", "этап 1 → 2"),
        av_li("Стрельбище", "", "этап 2 → 3"),
        av_li("Занятие по физподготовке", "", "этап 2 → 3"),
        av_li("Полоса препятствий", "", "этап 2 → 3"),
        av_li("Сопровождение курсантов при выезде из ВЧ", "за удостоверением, на стрельбище — самостоятельный выезд курсантам запрещён"),
        av_li("Помощь в наборе", "", "ВУ ст. 1.8"),
        av_li("Проверка отчётов курсантов на повышение, отметка ✅"),
    ]))

AV_CHAIN = ('<h3 class="chapter" id="av-order" data-short="Порядок обращения">Порядок обращения</h3>'
 '<p>По старшинству, через одну ступень не прыгать. К начальнику — когда вопрос не решён у заместителя либо по его прямому указанию.</p>'
 '<figure class="avfig"><svg viewBox="0 0 920 210" role="img" aria-label="Цепочка обращений: курсант к рядовому сотруднику или инструктору, '
 'инструктор к старшему инструктору, старший инструктор к заместителю начальника, заместитель к начальнику. Обращение через голову запрещено.">'
 '<defs><marker id="av-arr" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="8" markerHeight="8" orient="auto-start-reverse"><path d="M0,0 L10,5 L0,10 z" fill="currentColor"/></marker>'
 '<marker id="av-no" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="8" markerHeight="8" orient="auto-start-reverse"><path d="M0,0 L10,5 L0,10 z" style="fill:var(--signal)"/></marker></defs>'
 '<g font-size="13" text-anchor="middle" fill="currentColor">'
 '<rect x="10" y="110" width="130" height="52" rx="2" fill="none" stroke="currentColor" stroke-width="1.2"/><text x="75" y="141">Курсант</text>'
 '<rect x="190" y="110" width="150" height="52" rx="2" fill="none" stroke="currentColor" stroke-width="1.2"/><text x="265" y="132">Рядовой сотрудник</text><text x="265" y="150">/ Инструктор</text>'
 '<rect x="390" y="110" width="140" height="52" rx="2" fill="none" stroke="currentColor" stroke-width="1.2"/><text x="460" y="132">Старший</text><text x="460" y="150">инструктор</text>'
 '<rect x="580" y="110" width="140" height="52" rx="2" fill="none" stroke="currentColor" stroke-width="1.2"/><text x="650" y="132">Заместитель</text><text x="650" y="150">начальника</text>'
 '<rect x="770" y="110" width="140" height="52" rx="2" style="fill:var(--field);stroke:var(--field)" stroke-width="1.2"/><text x="840" y="141" style="fill:var(--paper)">Начальник АВНГ</text></g>'
 '<g stroke="currentColor" stroke-width="1.4" fill="none">'
 '<line x1="140" y1="136" x2="188" y2="136" marker-end="url(#av-arr)"/><line x1="340" y1="136" x2="388" y2="136" marker-end="url(#av-arr)"/>'
 '<line x1="530" y1="136" x2="578" y2="136" marker-end="url(#av-arr)"/><line x1="720" y1="136" x2="768" y2="136" marker-end="url(#av-arr)"/></g>'
 '<g font-size="11" text-anchor="middle" fill="currentColor" opacity=".7"><text x="164" y="128">вопрос</text><text x="364" y="128">не решён</text>'
 '<text x="554" y="128">не решён</text><text x="744" y="128">не решён</text></g>'
 '<path d="M265 110 C 300 30, 740 30, 810 108" fill="none" style="stroke:var(--signal)" stroke-width="1.6" stroke-dasharray="6 5" marker-end="url(#av-no)"/>'
 '<g transform="translate(535 52)"><circle r="11" style="fill:var(--signal)"/><path d="M-5,-5 L5,5 M5,-5 L-5,5" style="stroke:var(--paper)" stroke-width="2"/></g>'
 '<text x="535" y="30" font-size="12" text-anchor="middle" style="fill:var(--signal)">через голову — нарушение субординации</text>'
 '<text x="460" y="196" font-size="11.5" text-anchor="middle" fill="currentColor" opacity=".7">ВУ ст. 1.5 — обращение к непосредственному командиру · ВУ ст. 5.1 — субординация · ДУ ст. 8</text>'
 '</svg><figcaption>Каждый идёт на одну ступень вверх. Прямая дорожка к начальнику открыта только заместителю либо по указанию самого начальника.</figcaption></figure>'
 '<div class="avnotes">'
 '<div class="avnote"><b>1. Выше по составу — можно всё, что ниже</b>'
 '<p>Старший инструктор может провести присягу или лекцию, начальник — принять отчёт курсанта. Обратное запрещено: рядовой сотрудник не проводит присягу и не принимает экзамен.</p></div>'
 '<div class="avnote"><b>2. Обращаться по старшинству</b>'
 '<p>Курсант — к рядовому сотруднику или инструктору АВНГ. Рядовой сотрудник — к инструктору, инструктор — к старшему инструктору, старший инструктор — к заместителю начальника. '
 'К начальнику — только если вопрос не решён на уровне заместителя либо по его прямому указанию.</p>'
 '<p class="src">ВУ ст. 1.5, ст. 5.1 · обращение через голову без причины — ДУ ст. 8</p></div></div>')

AV_SOURCES = ('<h3 class="chapter" id="av-src" data-short="Основания">Основания</h3><div class="tw"><table>'
 '<tr><td><b>ВУ ст. 1.5</b></td><td>По служебным вопросам военнослужащий обращается к непосредственному командиру (начальнику)</td></tr>'
 '<tr><td><b>ВУ ст. 1.8</b></td><td>Набор — агитационные мероприятия и призывы по утверждённому графику</td></tr>'
 '<tr><td><b>ВУ ст. 1.11</b></td><td>Присяга обязательна для каждого прибывшего в часть</td></tr>'
 '<tr><td><b>ВУ ст. 5.1</b></td><td>Субординация — система иерархических отношений, уважения дисциплины и исполнения законных приказов</td></tr>'
 '<tr><td><b>ВУ ст. 8.2, 8.3</b></td><td>Повышение по представлению командира, согласованному с командованием; после нарушения — инструктаж или проверка знаний до повторного допуска</td></tr>'
 '<tr><td><b>ДУ ст. 6, 8</b></td><td>Переаттестация как мера взыскания; неуважительное обращение и обход законного порядка — нарушение субординации</td></tr>'
 '<tr><td><b>Система повышения</b></td><td>Пост Нач.АВНГ от 21.09.2026: шесть задач этапа 1 → 2, пять задач этапа 2 → 3, семь документов лекции, сопровождение выездов сотрудниками АВНГ, отчёты на АВНГ</td></tr>'
 '</table></div>')

av = dochead("du_", "Сотруднику · Академия ВНГ", "Карта обязанностей АВНГ",
             "Кто что делает на каждой ступени академии и к кому идти с вопросом. "
             "Обязанности нижней ступени вправе выполнять любой, кто выше; обратное запрещено.",
             ["<b>4 ступени</b>", "По посту Нач.АВНГ от <b>20.09.2026</b>", "Редакция <b>21.09.2026</b>"]) + \
     AV_LADDER + AV_CHAIN + AV_SOURCES

# ---------- сотруднику АВНГ: система повышения по баллам ----------
AS_STEPS = [("5 → 6", "200 б.", ""), ("6 → 7", "250 б.", "плюс экзамен по НПА ФСВНГ у старшего состава"),
            ("7 → 8", "300 б.", ""), ("8 → 9", "400 б.", ""), ("9 → 10", "500 б.", ""),
            ("10 → 11", "600 б.", ""), ("11 → 12", "700 б.", ""),
            ("12 → 13", "Собеседование", "у старшего состава подразделения")]
AS_ROUTE = '<div class="route">' + "".join(
    '<div class="rstep%s"><span class="rr">Ранг %s</span><span class="rt">%s</span><span class="rd">%s</span></div>'
    % (" fin" if i == len(AS_STEPS) - 1 else (" now" if cond else ""), esc(r), esc(pts), esc(cond or "баллов на счету"))
    for i, (r, pts, cond) in enumerate(AS_STEPS)) + '</div>'

def as_table(rows):
    return ('<div class="tw"><table><thead><tr><th>Действие</th><th>Баллы</th></tr></thead><tbody>'
            + "".join('<tr><td>%s</td><td><b>%s</b></td></tr>' % (esc(a), esc(b)) for a, b in rows) + '</tbody></table></div>')

AS_CADETS = [("Проверка одобренного отчёта на повышение", "10"), ("Проведение набора", "60"),
             ("Помощь в проведении набора", "40"), ("Проведение тренировки по физической подготовке", "30"),
             ("Проведение экзамена / принятие присяги", "50"), ("Проведение лекции / тренировки", "40 + 5 за каждого курсанта")]
AS_EVENTS = [("Участие в дропе", "60"), ("Участие в МП / ГМП от других фракций", "30"), ("Участие в поставке / крафте", "60"),
             ("Участие в рейде / военном положении / теракте", "100"), ("Участие в закрытии ачивки", "40"),
             ("Участие в отбитии ВЧ", "40"), ("Участие в отбитии банка / бизнеса / похищения", "20")]

asys = dochead("du_", "Сотруднику · Академия ВНГ", "Система повышения АВНГ",
               "Сотрудник академии растёт за баллы: их дают за работу с курсантами и участие в мероприятиях фракции. "
               "Два перехода требуют ещё и проверки старшим составом.",
               ["Ранги <b>5 → 13</b>", "<b>13</b> видов начислений", "По посту Нач.АВНГ от <b>19.09.2026</b>"]) + \
     ('<h3 class="chapter" id="as-ranks" data-short="Ранги и баллы">Ранги и баллы</h3>'
      '<p>Сколько баллов нужно накопить на каждый следующий ранг. Выделены переходы с дополнительным условием.</p>'
      + AS_ROUTE +
      '<h3 class="chapter" id="as-points" data-short="За что начисляют">За что начисляют баллы</h3>'
      '<h4>Работа с курсантами</h4>' + as_table(AS_CADETS) +
      '<h4>Участие в мероприятиях</h4>' + as_table(AS_EVENTS) +
      '<h3 class="chapter" id="as-notes" data-short="Примечания">Примечания</h3>'
      '<div class="note bad"><div class="h">Без доказательств баллы не начисляют</div>'
      '<p style="margin:0">Участие в поставке, дропе, МП и ГМП, рейде, ВП, теракте, захвате, задержании, закрытии ачивки и отбитии ВЧ '
      'подтверждается фото- или видеофиксацией. За проверку отчётов на повышение считаются <strong>только одобренные отчёты</strong>.</p></div>'
      '<p>Фиксация принимается через <strong>YouTube, Rutube, Google Drive, Яндекс Диск, Imgur, Yapx, Prnt, IBB</strong> '
      'и должна содержать полные и исчерпывающие доказательства выполнения действия.</p>')
...
for k, v in (("vu", vu), ("du", du), ("uk", uk), ("le", le), ("ru", ru), ("av", av), ("as", asys), ("ug", ug), ("ap", ap),
